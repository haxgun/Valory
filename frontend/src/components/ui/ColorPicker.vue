...
const presetColors: string[] = [
  '#BB2649', '#F25C54', '#A78EC1', '#FF9F00',
  '#43B2A1', '#F1F2F2', '#FF9E6D', '#004F8C',
  '#B4A0D0', '#F2C1D1', '#F1B79B', '#F4A300',
  '#0D7A56', '#E8C6D2', '#4C8C8B', '#6C6C6C',
];
      ...
      <div v-if="openColorPickerRef" class="color-picker" :class="{ 'up': isColorPickerUp }">
        ...
        >
          <div
            ...
            :style="{ left: `${saturation * 100}%`, top: `${(1 - brightness) * 100}%`, backgroundColor: hex }"
          ></div>
